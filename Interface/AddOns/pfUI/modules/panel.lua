pfUI:RegisterModule("panel", function ()
  ...
  pfUI.panel.clock.timerFrame.text:SetFont(pfUI.font_default,12, "OUTLINE")
  ...
  pfUI.panel.left.left.text:SetFont(pfUI.font_default,12, "OUTLINE")
  ...
  pfUI.panel.left.center.text:SetFont(pfUI.font_default,12, "OUTLINE")
  ...
  pfUI.panel.left.right.text:SetFont(pfUI.font_default,12, "OUTLINE")
  ...
  pfUI.panel.right.left.text:SetFont(pfUI.font_default,12, "OUTLINE")
  ...
  pfUI.panel.right.center.text:SetFont(pfUI.font_default,12, "OUTLINE")
  ...
  pfUI.panel.right.right.text:SetFont(pfUI.font_default,12, "OUTLINE")
