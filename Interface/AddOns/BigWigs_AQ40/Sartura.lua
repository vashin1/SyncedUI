...
BigWigsSartura.toggleoptions = {"whirlwind", "adds", "enrage", "berserk", "knockback", "bosskill"}
...
function BigWigsSartura:Knockback()
	self:TriggerEvent("BigWigs_StartBar", self, L["knockbackbartext"], 10, "Interface\\Icons\\Ability_Rogue_FeignDeath")
end