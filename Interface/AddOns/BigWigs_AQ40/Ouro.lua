...
L:RegisterTranslations("enUS", function() return {
	...
	emergetrigger = "Ouro begins to cast Birth.",
...
function BigWigsOuro:Sandblast()
	if self.db.profile.sandblast then
		...
		self:ScheduleEvent("bwouroblastwarn", "BigWigs_Message", 20, L["sandblastwarn"], "Important")
		self:TriggerEvent("BigWigs_StartBar", self, L["sandblastbartext"], 25, "Interface\\Icons\\Spell_Nature_Cyclone")
	end
end
